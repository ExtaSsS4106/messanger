...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'constraints': [models.UniqueConstraint(fields=('sender', 'receiver'), name='unique_friend_request'), models.CheckConstraint(condition=models.Q(('sender', models.F('receiver')), _negated=True), name='no_self_friend_request')],
            },
        ),
        migrations.CreateModel(
            name='Friends',
            ...
            options={
                'constraints': [models.UniqueConstraint(fields=('user1', 'user2'), name='unique_friendship'), models.CheckConstraint(condition=models.Q(('user1', models.F('user2')), _negated=True), name='no_self_friendship')],
            },
        ),
        migrations.CreateModel(
            name='Message',
            ...
            options={
                'ordering': ['created_at'],
                'indexes': [models.Index(fields=['user'], name='main_app_me_user_id_d21d43_idx'), models.Index(fields=['chat', 'created_at'], name='main_app_me_chat_id_7ae4e3_idx'), models.Index(fields=['chat', 'is_read'], name='main_app_me_chat_id_bad6f9_idx')],
            },
        ),
    ]
